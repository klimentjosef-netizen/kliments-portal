-- 0010 · Smlouvy jako doklad k opakovaným platbám (nájem, leasing, pojištění).
-- Dokument kind 'contract' s extracted: {naklad: true, ucet: '518', ucet_protistrany: '...',
-- castka: 15300, dph: 'neplatce'}; platby se k němu párují podle účtu protistrany
-- a v přehledu se započtou do nákladů.
