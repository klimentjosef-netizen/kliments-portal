-- ===========================================================================
-- Baseline migration: frozen production schema as of 2026-05-19.
-- DO NOT EDIT THIS FILE.  Add new migrations as 0002_*, 0003_*, ...
--
-- Source: PostgREST OpenAPI introspection (no DB password available at the
-- time of snapshot). For a complete pg_dump-grade baseline, regenerate via
-- `supabase db dump --schema public` once the DB password is provided.
--
-- Original snapshot file: ../schema.sql
-- ===========================================================================
